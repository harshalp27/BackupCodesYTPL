package com.equalsHashcode.howdoinjava;
	  ...
	  //      System.out.println(a1);
	    //    System.out.println(a2);
	      ...
	      //  System.out.println(//5==6);
	        ...
	        System.out.println("a1 key" + map.get(a1)); //Prints A_ONE
	        System.out.println("a2 key" + map.get(a2)); //Prints A_TWO
	        ...
	        System.out.println("Printing Map...!!!"); //Prints A_ONE
	        for (Account name: map.keySet()){
